...
function afficherContes() {
  ...
  if (!contesData) {
    container.innerHTML = `<p class="info-message">📖 ${window.t('contes_title') || 'Aucun conte disponible.'}</p>`;
    return;
  }
...
// Exporter
window.contesData = contesData;
window.chargerContes = chargerContes;
window.afficherContes = afficherContes;
